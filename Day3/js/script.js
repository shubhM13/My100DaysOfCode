// IIFE - Immediately Invoked Function Expression - Ensures all the variabes and functionality are protected improves code performace
(function () {
    ...
    document.querySelector('#fromDate').addEventListener('blur', () => { fromDate = document.querySelector('#fromDate').value;
            loadChart();});
    document.querySelector('#fromTime').addEventListener('blur', () => { fromTime = document.querySelector('#fromTime').value;
            loadChart();});
    document.querySelector('#toDate').addEventListener('blur', () => { toDate = document.querySelector('#toDate').value;
            loadChart();});
    document.querySelector('#toTime').addEventListener('blur', () => {toTime = document.querySelector('#toTime').value;
            loadChart();});
    loadChart();
})();
